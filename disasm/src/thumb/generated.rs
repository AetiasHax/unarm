...
use crate::thumb::disasm::{Ins, ParsedIns};
...
impl Ins {
    ...
    #[inline(always)]
    pub const fn field_rd_0(&self) -> Reg {
        Reg::parse((self.code & 0x00000007) as u8)
    }
    /// Rd_8: Destination register
    #[inline(always)]
    pub const fn field_rd_8(&self) -> Reg {
        Reg::parse(((self.code & 0x00000700) >> 8) as u8)
    }
    /// Rd_H1: Destination register
    #[inline(always)]
    pub const fn field_rd_h1(&self) -> Reg {
        let mut value = self.code & 0x00000007;
        value |= (self.code & 0x00000080) >> 4;
        Reg::parse(value as u8)
    }
    /// Rn_0: First source operand register
    #[inline(always)]
    pub const fn field_rn_0(&self) -> Reg {
        Reg::parse((self.code & 0x00000007) as u8)
    }
    /// Rn_3: First source operand register
    #[inline(always)]
    pub const fn field_rn_3(&self) -> Reg {
        Reg::parse(((self.code & 0x00000038) >> 3) as u8)
    }
    /// Rn_3_deref: Base register
    #[inline(always)]
    pub const fn field_rn_3_deref(&self) -> Reg {
        Reg::parse(((self.code & 0x00000038) >> 3) as u8)
    }
    /// Rn_8: First source operand register
    #[inline(always)]
    pub const fn field_rn_8(&self) -> Reg {
        Reg::parse(((self.code & 0x00000700) >> 8) as u8)
    }
    /// Rn_8_wb: First source operand register
    #[inline(always)]
    pub const fn field_rn_8_wb(&self) -> Reg {
        Reg::parse(((self.code & 0x00000700) >> 8) as u8)
    }
    /// Rn_H1: First source operand register
    #[inline(always)]
    pub const fn field_rn_h1(&self) -> Reg {
        let mut value = self.code & 0x00000007;
        value |= (self.code & 0x00000080) >> 4;
        Reg::parse(value as u8)
    }
    ...
    #[inline(always)]
    pub const fn field_rm_3(&self) -> Reg {
        Reg::parse(((self.code & 0x00000038) >> 3) as u8)
    }
    /// Rm_6: Second source operand register
    #[inline(always)]
    pub const fn field_rm_6(&self) -> Reg {
        Reg::parse(((self.code & 0x000001c0) >> 6) as u8)
    }
    /// Rm_6_offset: Offset register
    #[inline(always)]
    pub const fn field_rm_6_offset(&self) -> Reg {
        Reg::parse(((self.code & 0x000001c0) >> 6) as u8)
    }
    /// Rm_H2: Second source operand register
    #[inline(always)]
    pub const fn field_rm_h2(&self) -> Reg {
        Reg::parse(((self.code & 0x00000078) >> 3) as u8)
    }
    ...
    #[inline(always)]
    pub const fn field_registers_pc(&self) -> u32 {
        (self.code & 0x000001ff)
    }
    /// immed_3: 3-bit immediate
    #[inline(always)]
    pub const fn field_immed_3(&self) -> u32 {
        ((self.code & 0x000001c0) >> 6)
    }
    /// immed_8: 8-bit immediate
    #[inline(always)]
    pub const fn field_immed_8(&self) -> u32 {
        (self.code & 0x000000ff)
    }
    /// rel_immed_7: Address-relative 7-bit immediate
    #[inline(always)]
    pub const fn field_rel_immed_7(&self) -> u32 {
        let mut value = self.code & 0x0000007f;
        value <<= 0x00000002;
        value
    }
    /// rel_immed_8: Address-relative 8-bit immediate
    #[inline(always)]
    pub const fn field_rel_immed_8(&self) -> u32 {
    ...
    #[inline(always)]
    pub const fn field_left_shift_imm(&self) -> u32 {
        ((self.code & 0x000007c0) >> 6)
    }
    /// right_shift_imm: 5-bit right shift offset
    #[inline(always)]
    pub const fn field_right_shift_imm(&self) -> u32 {
        let mut value = (self.code & 0x000007c0) >> 6;
        value = match 0x00000001 {
    ...
    #[inline(always)]
    pub const fn field_branch_offset_8(&self) -> (i32, u8) {
        let mut value = (((self.code & 0x000000ff) as i32) << 24) >> 24;
        value <<= 0x00000001;
        value += 0x00000004;
        (value, 9)
    }
    /// branch_offset_11: 12-bit signed B/BL target offset
    #[inline(always)]
    pub const fn field_branch_offset_11(&self) -> (i32, u8) {
        let mut value = (((self.code & 0x000007ff) as i32) << 21) >> 21;
        value <<= 0x00000001;
        value += 0x00000004;
        (value, 12)
    }
    ...
    #[inline(always)]
    pub const fn field_high_branch_offset_11(&self) -> (i32, u8) {
        let mut value = (((self.code & 0x000007ff) as i32) << 21) >> 21;
        value <<= 0x0000000c;
        value += 0x00000004;
        (value, 23)
    ...
    #[inline(always)]
    pub const fn field_low_branch_offset_11(&self) -> u32 {
        let mut value = self.code & 0x000007ff;
        value <<= 0x00000001;
        value
    }
    /// low_blx_offset_11: 23-bit signed BLX target offset (low part)
    #[inline(always)]
    pub const fn field_low_blx_offset_11(&self) -> u32 {
        let mut value = self.code & 0x000007ff;
        value <<= 0x00000001;
        value &= 0xfffffffc;
        value
    ...
    #[inline(always)]
    pub const fn field_offset_5(&self) -> (i32, u8) {
        let mut value = ((((self.code & 0x000007c0) >> 6) as i32) << 21) >> 21;
        value <<= 0x00000002;
        (value, 7)
    }
    /// cond: Condition code
...
pub enum Argument {
    ...
    RegList(u32),
    /// reg_list_pc: List of general-purpose registers, including PC
    RegListPc(u32),
...
fn parse_add_sp7(out: &mut ParsedIns, ins: Ins) {
    *out = ParsedIns {
        mnemonic: "add",
        args: [Argument::Sp, Argument::UImm(ins.field_rel_immed_7()), Argument::None],
    };
}
...
fn parse_ldmia(out: &mut ParsedIns, ins: Ins) {
    *out = ParsedIns {
        mnemonic: "ldmia",
        args: [
            Argument::RegWb(ins.field_rn_8_wb()),
...
fn parse_ldr_i(out: &mut ParsedIns, ins: Ins) {
    *out = ParsedIns {
        ...
        args: [
            Argument::Reg(ins.field_rd_0()),
            Argument::RegDeref(ins.field_rn_3_deref()),
            Argument::Offset(ins.field_offset_5()),
        ],
    };
}
fn parse_ldr_r(out: &mut ParsedIns, ins: Ins) {
    *out = ParsedIns {
        ...
        args: [
            Argument::Reg(ins.field_rd_0()),
            Argument::RegDeref(ins.field_rn_3_deref()),
            Argument::RegOffset(ins.field_rm_6_offset()),
        ],
    };
}
...
fn parse_pop(out: &mut ParsedIns, ins: Ins) {
    *out = ParsedIns {
        mnemonic: "pop",
        args: [
            Argument::RegListPc(ins.field_registers_pc()),
            Argument::None,
            Argument::None,
        ],
    };
